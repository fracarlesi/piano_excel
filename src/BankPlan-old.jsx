...
// All divisions now use StandardDivisionSheet
      ...
      case 'techPlatform': 
        return (
          <StandardDivisionSheet
            ...
            divisionResults={results.divisions.tech || {}}
            productResults={Object.fromEntries(
      ...
      case 'centralFunctions':
        return (
          <StandardDivisionSheet
            ...
            productResults={{}} // No products for central functions
            assumptions={assumptions}
            globalResults={results}
            onAssumptionsChange={handleAssumptionsChange}
            editMode={editMode}
      ...
      case 'treasury':
        return (
          <StandardDivisionSheet
            ...
            productResults={{}} // Treasury doesn't have traditional products
            assumptions={assumptions}
            globalResults={results}
            onAssumptionsChange={handleAssumptionsChange}
            editMode={editMode}
