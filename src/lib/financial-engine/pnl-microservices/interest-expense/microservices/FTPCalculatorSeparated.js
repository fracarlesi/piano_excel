...
export const calculateProductFTPSeparated = (product, productAssumptions, euribor) => {
  ...
  console.log(`🔍 FTP Calculator Separated - Product: ${productAssumptions.name}`, {
  ...
  if (hasActivity) {
    console.log(`    💰 FTP Results Separated for ${productAssumptions.name}:`, {
...
export const calculateDivisionFTPSeparated = (divisionData, divisionAssumptions, euribor) => {
  console.log(`💰 FTP Calculator Separated - Processing division: ${divisionAssumptions?.name || 'Unknown'}`);
