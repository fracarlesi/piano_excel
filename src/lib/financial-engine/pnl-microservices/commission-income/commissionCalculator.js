...
export const calculateCommissionIncome = (balanceSheetResults, assumptions, quarters = 40) => {
  ...
  if (!balanceSheetResults?.newVolumes?.byProduct) {
    console.warn('❌ Commission Income Calculator: No new volumes data found in balance sheet results');
    console.log('balanceSheetResults keys:', Object.keys(balanceSheetResults || {}));
    return results;
  }
  
  console.log('✅ Commission Income Calculator: Starting calculation with volumes:', 
  ...
  console.log('💰 Commission Calculator - Available volume keys:', Object.keys(newVolumesByProduct));
  console.log('💰 Commission Calculator - Product structure:', Object.keys(assumptions.products || {}));
  ...
  console.log('💰 Commission Income Calculator Results:', {
    totalCommissions,
    productCount,
