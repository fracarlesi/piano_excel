...
import { realEstateProducts } from '../backend/products';
...
const REAssumptions = () => {
  ...
  const divisionAssumptions = assumptions.realEstateDivision;
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-xl font-semibold">Real Estate Division - Assumptions</h2>
      </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          {Object.entries(realEstateProducts).map(([productKey, product]) => {
