...
import { EditableNumberField, EditableSelectField } from '../../../components/ui/inputs';
    ...
    <>
      ...
      <Card className="mb-4">
        ...
        <CardContent className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <EditableNumberField
            label="Commissione (%)"
            value={product.commissionRate || 0.5}
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <EditableSelectField
            ...
            editMode={true}
            options={[
              { value: 'bullet', label: 'Bullet (Bridge)' },
          ...
          <EditableSelectField
            ...
            onChange={(value) => handleChange('creditClassification', value)}
            editMode={true}
            options={[
              { value: 'Bonis', label: 'Bonis' },
              { value: 'UTP', label: 'UTP' }
            ]}
          />
        </CardContent>
