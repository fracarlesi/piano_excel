/**
 * Bridge Loans Volumes Calculator
 * 
 * Calcola i nuovi volumi erogati per prestiti bridge/bullet
...
/**
 * Calculate new volumes for bridge/bullet loans
 ...
 */
export const calculateBridgeLoansVolumes = (product, assumptions, quarters = 40) => {
  const results = {
