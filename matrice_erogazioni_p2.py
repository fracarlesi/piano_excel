# Script Python per Matrice Erogazioni - Prodotto 2
# Da usare con formula =PY() in Excel

def calcola_erogazione_p2(anno, trimestre, row_num, col_num):
    """
    Calcola l'erogazione per il Prodotto 2 nella matrice diagonale
    ...
    # Mix prodotto 2 (cella E66) - DIFFERENZA DAL PRODOTTO 1
    mix_prodotto = ws_input.range('E66').value
...
def matrice_erogazioni_prodotto2():
    """
    Genera l'intera matrice erogazioni per il Prodotto 2
    ...
    # Mix prodotto 2 - DIFFERENZA DAL PRODOTTO 1
    mix_prodotto = ws_input.range('E66').value or 0
